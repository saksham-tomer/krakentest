...
const PreviewMedia = ({ musicUrl, mediaUrl, mediaType, alt, width = 230, height = 230 }) => {
  ...
  return (
    <div
      className="relative h-[230px] rounded-[0.625rem] overflow-hidden"
    ...
    >
      {mediaType.startsWith("video/") ? (
        ...
        <img
          ...
          width={width}
          height={height}
          className="w-full h-full object-cover rounded-[0.625rem] max-h-[400px]"
          loading="lazy"
          draggable="false"
          onDragStart={(e) => e.preventDefault()}
          onMouseDown={(e) => e.preventDefault()}
